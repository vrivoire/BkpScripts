...
@echo usb_key
@echo -------------------------------------------------------------------------
start "USB Key" %HOMEDRIVE%%HOMEPATH%\Documents\BkpScripts\Ventille\usb_key.cmd"
@echo Fin usb_key -------------------------------------------------------------

@echo -------------------------------------------------------------------------
@echo Videos
@echo -------------------------------------------------------------------------
start "Videos" %HOMEDRIVE%%HOMEPATH%\Documents\BkpScripts\Ventille\Videos.cmd"
@echo Fin Videos --------------------------------------------------------------
...
@echo Nuage
@echo -------------------------------------------------------------------------
start "Nuage" %HOMEDRIVE%%HOMEPATH%\Documents\BkpScripts\Ventille\Nuage.cmd"
@echo Fin Nuage ---------------------------------------------------------------
...
@echo Programs
@echo -------------------------------------------------------------------------
start "Programs" "%HOMEDRIVE%%HOMEPATH%\Documents\BkpScripts\Ventille\bkp2.cmd" A Programs
@echo Fin Programs -----------------------------------------------------------
...
@echo Documents
@echo -------------------------------------------------------------------------
start "Documents" %HOMEDRIVE%%HOMEPATH%\Documents\BkpScripts\Ventille\Documents.cmd"
@echo Fin Documents -----------------------------------------------------------
